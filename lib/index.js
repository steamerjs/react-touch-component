...
var ua = _global2.default.navigator && _global2.default.navigator.userAgent && _global2.default.navigator.userAgent.toLowerCase();
...
var Touch = function (_Component) {
	...
	function Touch(props, context) {
		...
		_this.devicePixelRatio = _global2.default.devicePixelRatio || 1;
	...
	Touch.prototype.componentDidMount = function componentDidMount() {
		_global2.default.addEventListener('scroll', this.cancelAll, false);
	};

	Touch.prototype.componentWillUnmount = function componentWillUnmount() {
		_global2.default.removeEventListener('scroll', this.cancelAll, false);
	};
	...
	Touch.prototype.touchEnd = function touchEnd(e) {
		...
		if (this.touchInfo.x2 && pos.absX > this.maxTapAbsX || this.touchInfo.y2 && pos.absY > this.maxTapAbsY) {
			var time = Date.now() - this.touchInfo.start,
...
Touch.propTypes = {
	...
	onLongTap: _propTypes2.default.func,
